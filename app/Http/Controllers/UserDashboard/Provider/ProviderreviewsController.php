...
class ProviderreviewsController extends Controller
{
    ...
    {
        $appId = CustomerReview::where('provider_id',Auth::user()->id)->latest()->pluck('appointment_id');
    ...
    public function show($id)
    {
        ...
        return view('dashboard.provider.review.review-dtls',$data);
    }
    ...
    {
        $data['findEditid']= CustomerReview::find($id);
