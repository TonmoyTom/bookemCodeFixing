                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <div class="card-body">
                                <form action="{{ route('provider.update', $editData->id) }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Name" name="name" value="{{ $editData->business_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Business Category</label>
                                                ...
                                                <option value="{{$category->id}}"  @if (@in_array(['category_id' => $category->id], $selectCategory)) selected @endif >{{ $category->category_name}}</option>
                                                @endforeach
                                            </select>
                                            <div style='color:red; padding: 0 5px;'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="phone" name="mobile" type="tel" placeholder="Enter phone number"  class="form-control" value="{{ $editData->mobile }}">
                                ...
                                <div class="row">
                                    ...
                                    <input
                                        ...
                                        type="text" name="address" id="address" value="{{ $editData->address }}"
