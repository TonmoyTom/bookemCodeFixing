...
@section('title', ' Canceled Appointment Details')
@section('content')
    <!--begin::Content-->
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Canceled Appointment Details
                                <span class="d-block text-muted pt-2 font-size-sm">All canceled details here</span>
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('appointment.cancel.index') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <b class="col-sm-3">Service Amount </b>
                            <b class="col-sm-1"> : </b>
                            <dd class="col-sm-8">${{ $data->service_amount }}</dd>
                            ...
                            <b class="col-sm-3">Booking Date & Time </b>
                            <b class="col-sm-1"> : </b>
