            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5"> Appointment History</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Appointment History List
                                <span class="d-block text-muted pt-2 font-size-sm">All appiontments history here</span>
                            </h3>
                        </div>
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-separate table-head-custom" id="dataTable">
                            ...
                            <tbody>
                                @foreach ($appointmentshistorys as $appointment)
