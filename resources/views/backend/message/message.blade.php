                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('contact.edit',$messag->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                   
                                    <a id="delete" href="{{route('contact.destroy',$messag->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3">
