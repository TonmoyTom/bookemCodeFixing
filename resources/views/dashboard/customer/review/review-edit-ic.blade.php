            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body table-responsive">
                        <!--begin: Datatable-->
                        <form action="{{ route('customer.review.icupdate', $icEdit->id)}}" method="POST">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="full-stars-example-two">
                                        <div class="rating-group">
                                            ...
                                            <input @if ($icEdit->rating == 1) checked @endif class="rating__input" name="rating"
                                                id="rating3-1" value="1" type="radio">
                                            <label aria-label="2 stars" class="rating__label"
                                                for="rating3-2"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($icEdit->rating == 2) checked @endif class="rating__input" name="rating"
                                                id="rating3-2" value="2" type="radio">
                                            <label aria-label="3 stars" class="rating__label"
                                                for="rating3-3"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($icEdit->rating == 3) checked @endif class="rating__input" name="rating"
                                                id="rating3-3" value="3" type="radio">
                                            <label aria-label="4 stars" class="rating__label"
                                                for="rating3-4"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($icEdit->rating == 4) checked @endif class="rating__input" name="rating"
                                                id="rating3-4" value="4" type="radio">
                                            <label aria-label="5 stars" class="rating__label"
                                                for="rating3-5"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($icEdit->rating == 5) checked @endif class="rating__input" name="rating"
