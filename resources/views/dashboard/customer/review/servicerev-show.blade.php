                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Service Review Details
                            </h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            @php
                            $serviceReviewData = App\Models\ServiceReview::where('appointment_id',$data->id)->first();
