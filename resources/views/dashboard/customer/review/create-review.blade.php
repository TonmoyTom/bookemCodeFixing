...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <!--begin::Card-->
           @if($findid->ic_id !=null && $findid->provider_id !=null)
           <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Create Independent Contractor Reviews
                    </h3>
                </div>
            ...
            <div class="card-body table-responsive">
                ...
                <form action="{{ route('customer.review.store')}}" method="POST">
                    ...
                    <input type="hidden" name="review_id" value="{{ $findid->id}}">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control comment" name="description" placeholder="Type here.."></textarea>
                            <div style="color: red; padding:0 5px;">
                    ...
                    <hr>
                    <div class="card-header flex-wrap py-5 mb-3">
                        <div class="card-title">
                            <h3 class="card-label">Create Service Reviews
                            </h3>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <label>Select Service</label>
                            <select name="service_id[]" class="form-control myselect2" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <div id="full-stars-example-two">
                                <div class="service-rating-group">
                                    <input disabled checked class="service-rating__input service-rating__input--none" name="service_rating" id="servicerating3-none" value="0" type="radio">
                                    ...
                                    <input class="service-rating__input" name="service_rating" id="servicerating3-1" value="1" type="radio">
                                    ...
                                    <input class="service-rating__input" name="service_rating" id="servicerating3-2" value="2" type="radio">
                                    ...
                                    <input class="service-rating__input" name="service_rating" id="servicerating3-3" value="3" type="radio">
                                    ...
                                    <input class="service-rating__input" name="service_rating" id="servicerating3-4" value="4" type="radio">
                                    ...
                                    <input class="service-rating__input" name="service_rating" id="servicerating3-5" value="5" type="radio">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Create Facility Reviews
                    </h3>
                </div>
