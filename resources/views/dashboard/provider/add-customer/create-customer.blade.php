            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Create Customer
                            <span class="d-block text-muted pt-2 font-size-sm">Create Customer here</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('provider.add.customer.index')}}" class="btn btn-success btn-sm font-weight-bolder"> <i class="la la-angle-left"></i>
                            Back</a>
                                <!--end::Button-->
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Customer Name" name="name" value="{{ old('name') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Enter Customer Email" name="email" value="{{ old('email') }}">
                                    <div style='color:red; padding: 0 5px;'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Customer Phone Number" name="mobile" value="{{ old('mobile') }}">
                                    <div style='color:red; padding: 0 5px;'>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Customer Addres" name="address" value="{{ old('address') }}">
                                    <div style='color:red; padding: 0 5px;'>
