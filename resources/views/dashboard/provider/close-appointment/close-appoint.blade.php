                    ...
                    <table class="table table-separate table-head-custom" id="dataTable">
                        ...
                        <tbody>
                          ...
                          <tr>
                                ...
                                <td>
                                    <a href="{{route('provider.appointment.cancel.show',$appointment->id)}}" class="btn btn-clean btn-sm">View</a>

                                   
                                        <a id="course_status" href="{{ route('provider.appointment.cancel.rebook',$appointment->id)}}" class="btn btn-sm btn-clean mr-2">Rebook</a>
                                </td>
                            </tr>
