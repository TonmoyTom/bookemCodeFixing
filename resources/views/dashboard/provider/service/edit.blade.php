        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <form action="{{route('user.service.update',$service->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="selling_price" value="{{$service->selling_price}}" id="selling_price" class="form-control" placeholder="Enter selling price">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="service_min" class="form-control html-duration-picker"
                                             id="service_min" placeholder="Service Duration" value="{{$minInterval->cascade()->format('%H:%I:%S')}}">
                                        <div style='color:red; padding: 0 5px;'>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="service_min_setup" class="form-control html-duration-picker"
                                            id="service_min_setup" placeholder="Setup Duration" value="{{$setupMinInterval->cascade()->format('%H:%I:%S')}}" >
                                        <div style='color:red; padding: 0 5px;'>
                                            {{ $errors->has('service_min') ? $errors->first('service_min') : '' }}</div>
                                    </div>
                                </div>
