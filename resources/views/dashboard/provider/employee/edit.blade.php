                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="javascript:;" class="text-muted">Edit Employee</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{route('add.employee.index')}}" class="btn btn-success font-weight-bolder">
                            <i class="la la-angle-left"></i>Back</a>
                                <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('add.employee.update',$dataIcedit->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span>If you want change the customer password.So enter the new password</span>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ asset($dataIcedit->image) }})">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Sevices</label>
                                            ...
                                            <option value="{{$category->id}}"  @if (@in_array(['service_id' => $category->id], $selectCategory)) selected @endif >{{ $category->name}}</option>
                                            @endforeach
                                        </select>
                                        <div style='color:red; padding: 0 5px;'>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Enter Confirm password" name="expreinces_to"  value="{{$dataIcedit->exprineces->experince_from}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Expreinces Date To</label>
                                        <input type="text"  id="currentDate" disabled class="form-control" placeholder="Enter Confirm password" name="expreinces_date" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Enter Details" name="experinces">{{$dataIcedit->exprineces->experinces}} </textarea>
                                    </div>
                                </div>
                            </div>
