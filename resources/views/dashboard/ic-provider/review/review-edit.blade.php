            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body table-responsive">
                        <!--begin: Datatable-->
                        <form action="{{ route('ic.provider.review.update', $findEditid->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <!-- Rating Stars Box -->
                                    <label>Select Your Reviews</label>
                                    ...
                                    <div id="full-stars-example-two">
                                        <div class="rating-group">
                                            ...
                                            <input @if ($findEditid->rating == 1) checked @endif class="rating__input" name="rating"
                                                id="rating3-1" value="1" type="radio">
                                            <label aria-label="2 stars" class="rating__label" for="rating3-2"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($findEditid->rating == 2) checked @endif class="rating__input" name="rating"
                                                id="rating3-2" value="2" type="radio">
                                            <label aria-label="3 stars" class="rating__label" for="rating3-3"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($findEditid->rating == 3) checked @endif class="rating__input" name="rating"
                                                id="rating3-3" value="3" type="radio">
                                            <label aria-label="4 stars" class="rating__label" for="rating3-4"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($findEditid->rating == 4) checked @endif class="rating__input" name="rating"
                                                id="rating3-4" value="4" type="radio">
                                            <label aria-label="5 stars" class="rating__label" for="rating3-5"><i
                                                    class="rating__icon rating__icon--star fa fa-star"></i></label>

                                            <input @if ($findEditid->rating == 5) checked @endif class="rating__input" name="rating"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control comment" name="description"
                                                    placeholder="Type here..">{{ $findEditid->description }} </textarea>
                                                <div style="color: red; padding:0 5px;">
                                        ...
                                        <input type="hidden" name="customer_id" value="{{ $findEditid->customer_id  }}">
                        </form>
                        <!--end: Datatable-->
                    </div>
                </div>
