                        ...
                        <tbody>
                            @foreach ($appointments as $appointment)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('ic.provider.review.show', $appointment->id) }}"
                                            class="btn btn-icon btn-clean btn-sm"><i class="la la-eye"></i></a>
                                        <a href="{{ route('ic.provider.review.edit', $rating->id) }}"
                                            class="btn btn-icon btn-clean btn-sm"><i class="la la-edit"></i></a>
                                        <a id="delete" href="{{ route('ic.provider.review.destroy', $rating->id) }}"
