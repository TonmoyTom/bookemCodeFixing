...
<div class="subscribe-box pb-5 my-5">
    ...
    <form action="{{ route('coupon.payment') }}" method="post" id="payment-form">
        @csrf
        ...
        <div class="subs-body mt-3">
            <div class="subs-payment">
                <div class="subs-step">
                    <p class="mb-2">Pay for ( {{$coupon->name}} )</p>
                </div>
            ...
            <div class="subs-button text-center mt-5 mb-3">
                <button class="" type="submit" tabindex="0">Pay Now ${{ $coupon->price }}</button>
            </div>
        </div>
    </form>
</div>
